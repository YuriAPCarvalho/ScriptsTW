...
if (game_data.locale == "pt_BR") {
    // Servidor Brasileiro (Português)
    langShinko = [
        "Coletas em massa",
        "Selecione os tipos de unidades para coletar",
        "Selecione as categorias a serem usadas",
        "Digite a duração desejada das coletas em HORAS",
        "Digite o tempo aqui",
        "Calcular os tempos para todas as páginas",
        "Criador: ",
        "Coletas em massa: enviar para 50 vilas",
        "Iniciar grupo"
    ];
}
